...
/**
 * File: HomeButtonTypeContent.java
 * Author: yuzhuzhang
 * Create: 2020/4/4 6:14 PM
 * Description: TODO
 * -----------------------------------------------------------------
 * 2020/4/4 : Create HomeButtonTypeContent.java (yuzhuzhang);
 * -----------------------------------------------------------------
 */
public interface HomeButtonTypeContent {

    //主页按钮存储标签
    String TYPE_MAIN_BUTTON_DATA = "TYPE_MAIN_BUTTON_DATA";
    //全部按钮存储标签
    String TYPE_ALL_BUTTON_DATA = "TYPE_ALL_BUTTON_DATA";
    //按钮分组 标题
    String TYPE_LOCAL_LIST_NAME_THRID = "跳转第三方APP";
    String TYPE_LOCAL_LIST_NAME_WEB = "webView";
    String TYPE_LOCAL_LIST_NAME_OTHER = "Other";
    String TYPE_LOCAL_LIST_NAME_SET = "Set";
    //按钮分组 类型
    String TYPE_LOCAL_LIST_TYPE_THRID = "thridApp";
    String TYPE_LOCAL_LIST_TYPE_WEB = "webView";
    String TYPE_LOCAL_LIST_TYPE_OTHER = "Other";
    String TYPE_LOCAL_LIST_TYPE_SET = "Set";
    //按钮来源 服务器数据：0；本地数据：1；
    int SERVER_TYPE = 0;
    int LOCAL_TYPE = 1;
    /**
     ...
     */
    //根据本地类跳转Activity
    String TYPE_LOCAL_CLASS_J_ACTIVITY = "TYPE_LOCAL_CLASS_J_ACTIVITY";
    //根据本地String跳转Activity
    String TYPE_LOCAL_STRING_J_ACTIVITY = "TYPE_LOCAL_STRING_J_ACTIVITY";
    //根据服务器返回String类型包名和类名跳转Activity
    String TYPE_URL_CLASS_J_ACTIVITY = "TYPE_URL_CLASS_J_ACTIVITY";
    //本地设置APP跳转(图标显示问题)
    String TYPE_LOCAL_SKIP_APP = "TYPE_LOCAL_SKIP_APP";
    //根据服务器返回数据进行APP跳转类型
    String TYPE_URL_SKIP_APP = "TYPE_URL_SKIP_APP";
    //根据服务器返回数据跳转WebView/H5
    String TYPE_URL_J_WEBVIEW_H5 = "TYPE_URL_J_WEBVIEW_H5";
    //本地URL数据跳转WebView/H5
    // String TYPE_LOCAL_J_WEBVIEW_H5 = "TYPE_LOCAL_J_WEBVIEW_H5"
    //Android App跳转指定的Activity
    String  TYPE_SKIP_APP_START_ACTIVITY = "AndroidAppStartActivity";
    //AndroidAPP跳转Packagename
    String TYPE_SKIP_APP_PACKAGE_NAME = "AndroidAppPackageName";
    //AndroidAPP下载路径
    String TYPE_SKIP_APP_DOWN_LOAD_PATH = "AndroidAppDownLoadPath";

    String netData = "{\"state\": \"1\", \"type\": \"MainButtons\",\"data\": " +
