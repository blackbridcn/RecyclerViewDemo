package org.x5webview.activity;
...
public class MainActivity /* extends Activity*/ {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(org.x5webview.R.layout.activity_main_advanced);
		mContext = this;
		if (!main_initialized) {
			this.new_init();
		}
	...
	private void new_init() {
		...
		this.gridView = (GridView) this.findViewById(org.x5webview.R.id.item_grid);

		if (gridView == null)
			throw new IllegalArgumentException("the gridView is null");

		titles = getResources().getStringArray(org.x5webview.R.array.index_titles);
		int[] iconResourse = { org.x5webview.R.mipmap.tbsweb, org.x5webview.R.mipmap.fullscreen,
				org.x5webview.R.mipmap.filechooser };
		...
		this.gridAdapter = new SimpleAdapter(this, items,
				org.x5webview.R.layout.function_block, new String[] { "title", "icon" },
				new int[] { org.x5webview.R.id.Item_text, org.x5webview.R.id.Item_bt });
