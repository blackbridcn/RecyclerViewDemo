...
import org.x5webview.sdkinterface.X5WebView;

import java.net.MalformedURLException;
import java.net.URL;

import blackbird.com.x5viewmodel.R;
...
public class X5BrowserActivity extends Activity {
    ...
    private void initProgressBar() {
        ...
        mPageLoadingProgressBar.setProgressDrawable(this.getResources()
                .getDrawable(R.mipmap.color_progressbar));
    }
    ...
    private void initBtnListenser() {
        ...
        mMore.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(X5BrowserActivity.this, "not completed",
